        ...
        },
        {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    caller_name: { type: "string" as const, description: "Nombre del cliente" },
                    date: { type: "string" as const, description: "Fecha de la cita a cancelar (YYYY-MM-DD)" },
                    time: { type: "string" as const, description: "Hora de la cita a cancelar (HH:MM)" },
                },
