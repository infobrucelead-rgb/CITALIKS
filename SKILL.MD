...
## Roles del Equipo
1. **Director (PABLO)l líder. Divide el problema, asigna roles y aprueba planes.
...
Antes de realizar cambios significativos, cada agente debe enviar un **Plan de Acción** al buzón de PABLOBOT.
...
- **Broadcast**: PABLOBOT puede escribir en `broadcast.msg` para dar nuevas directrices a todo el equipo simultáneamente.
...
---
*CREADOPOR PABLO Y ALEJANDRO BOT*.
