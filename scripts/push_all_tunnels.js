...
const TUNNEL_URL = "https://14d1077f22b2cd.lhr.life";
...
async function run() {
    ...
    for (const client of clients) {
        ...
        console.log(`\n--- UPDATING CLIENT: ${client.businessName} ---`);
        ...
        await makeRequest(`/update-retell-llm/${llmId}`, 'PATCH', {
            tools: [
                ...tools,
                {
                    type: "transfer_call",
                    name: "transfer_call",
                    number: client.transferPhone || "+34614202364",
        ...
        console.log(`Successfully updated ${client.businessName}`);
    }
}
